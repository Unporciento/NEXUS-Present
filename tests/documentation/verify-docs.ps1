...
$required = @(
  ...
  'docs/ECOSYSTEM_STANDARD.md','docs/LABORATORY.md','docs/PRODUCT_VISION_1_0.md','docs/PLAYER_CONTRACT.md','docs/RESPONSIVE_REVIEW.md',
...
$forbiddenUi = Get-ChildItem -LiteralPath $Root -Recurse -File | Where-Object { ($_.Extension -in '.html','.css' -and $_.Name -notin 'index.html','styles.css') -or ($_.Extension -in '.js','.mjs' -and $_.FullName -notmatch '[\\/](src[\\/](contracts|player|ui|input)|tests|demo|tools)[\\/]' -and $_.Name -ne 'app.js') }
...
if ($main -ne '0758990ebd29a217b6ad81f412e2d69d64dc99ec') { $errors.Add('main moved from the approved Phase 2 completion commit.') }
