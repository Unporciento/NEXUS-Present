  ...
  return {
    async prepare(sourceDocument, draftKey, { signal } = {}) {
      ...
      try {
        ...
        entries.push([`${root}/index.html`, new TextEncoder().encode(`<!doctype html><html lang="es" data-engine-version="${engineVersion}"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="description" content="Presentación portable NEXUS"><meta http-equiv="Content-Security-Policy" content="default-src 'self'; img-src 'self' blob: data:; media-src 'self' blob:; style-src 'self'; script-src 'self'; connect-src 'self'; object-src 'none'; base-uri 'none'; form-action 'self'"><title>${publicDocument.title.replace(/[<>&"]/g, '')} · NEXUS</title><link rel="stylesheet" href="runtime/styles.css"></head><body><div id="app"></div><script type="module" src="runtime/portable/runtime-app.js"></script></body></html>\n`)]);
